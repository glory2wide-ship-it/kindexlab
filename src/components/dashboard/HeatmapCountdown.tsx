...
/** Prior 13.721 / 16.771 +5% → 14.407 / 17.610. */
const LABEL_CLASS = "text-[14.407px] font-bold leading-none tracking-tight whitespace-nowrap text-white";
const CLOCK_CLASS = "refresh-countdown text-[17.61px] font-bold tabular-nums leading-none text-white";
