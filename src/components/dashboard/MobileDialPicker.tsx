  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Center selection face — fill only, no border; +25% width vs prior 36% */}
        <div
          className="pointer-events-none absolute inset-y-0.5 left-1/2 w-[45%] -translate-x-1/2 rounded bg-accent/25"
          aria-hidden
        />
      </div>
