...
const TAB_BASE =
  "rounded-md px-1.5 py-1 text-[12.96px] font-medium tracking-tight transition-[color,background-color,transform] duration-200 ease-out lg:px-3 lg:py-1.5 lg:text-[14.256px] lg:tracking-normal";
...
export function RegionFilterTabs({
  ...
  return (
    <div className="flex min-w-0 flex-wrap items-center gap-2" role="tablist" aria-label="지역">
