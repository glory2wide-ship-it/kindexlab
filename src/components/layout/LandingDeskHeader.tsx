...
export function LandingDeskHeader() {
  return (
    <header className="space-y-1.5 font-gothic md:space-y-2">
      <h1 className="whitespace-nowrap text-[clamp(11px,2.95vw,18px)] font-semibold leading-none tracking-tighter md:whitespace-normal md:text-3xl md:leading-snug md:tracking-tight">
        {SITE_INDEX_HEADLINE_DESKTOP}
      </h1>
