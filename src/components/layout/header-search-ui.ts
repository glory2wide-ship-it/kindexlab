...
export const SEARCH_BUTTON_MOBILE_CLASS =
  "grid h-full min-h-[28px] w-full min-w-[2rem] shrink-0 place-items-center rounded-md border border-line bg-panel text-ink transition-colors hover:text-accent md:hidden";
