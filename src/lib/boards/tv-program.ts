...
const SERVICE_EVENT_NOISE =
  /(유튜브\s*중단|유튜브\s*장애|요요\s*없는|요요없는|예비\s*글로벌|글로벌\s*축제|축제$|수발|A\s*\/\s*S|A\/S|에이에스|애프터\s*서비스|AS\b|고객센터|콜센터|수리|교체|보증|다이어트|살빼|비만|클리닉|병원$|의원$|약국$|보험료|대출|금리|공매도|펀드|ETF|채권)/i;
