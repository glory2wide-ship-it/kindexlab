...
export function heatmapNameDisplayRules(): string {
  return [
    ...
    "6. 영어 한 단어(공백 없음, 예: LEMONADE·Whiplash)는 한 줄로 둔다. 띄어쓰기가 있는 영어(예: LOVE ATTACK)만 2줄 분리를 허용한다.",
    "7. 실패 예: 연극〈더 / 헬멧〉, 든든전 / 세주택, 청년도 / 약계좌, 스포츠강 / 좌이용권, LE / MONADE. 성공 예: 연극 / 〈더 헬멧〉, 든든 / 전세주택, 청년 / 도약계좌, 스포츠강좌 / 이용권, LEMONADE(1줄).",
  ].join("\n");
}
