...
export const POLITICS_CATALOG: PoliticsCatalogEntry[] = [
  ...
  { name: "정의당", nameEn: "Justice Party", type: "party_support", tags: ["원내"], searchQuery: "정의당" },
  { name: "새로운미래", nameEn: "New Future Party", type: "party_support", aliases: ["새미래"], tags: ["원내"], searchQuery: "새로운미래" },
  { name: "국민의당", nameEn: "People's Party", type: "party_support", tags: ["원내"], searchQuery: "국민의당" },
  { name: "열린민주당", nameEn: "Open Democratic Party", type: "party_support", tags: ["원내"], searchQuery: "열린민주당" },
  { name: "시대전환", nameEn: "Transition Korea", type: "party_support", tags: ["원내"], searchQuery: "시대전환" },
  { name: "녹색당", nameEn: "Green Party", type: "party_support", tags: ["원내"], searchQuery: "녹색당" },
  { name: "민생당", nameEn: "Minsaeng Party", type: "party_support", tags: ["원내"], searchQuery: "민생당" },
  ...
  { name: "장성철", nameEn: "Jang Sung-cheol", type: "political_pundit", tags: ["시사평론가"], searchQuery: "시사 토론" },
  { name: "배종찬", nameEn: "Bae Jong-chan", type: "political_pundit", tags: ["여론조사"], searchQuery: "여론조사" },
  { name: "박성민", nameEn: "Park Sung-min", type: "political_pundit", tags: ["정치컨설턴트"], searchQuery: "정치 컨설팅" },
  { name: "조기숙", nameEn: "Cho Ki-suk", type: "political_pundit", tags: ["시사평론가"], searchQuery: "시사 토론" },
  { name: "금태섭", nameEn: "Keum Tae-sup", type: "political_pundit", tags: ["시사평론가"], searchQuery: "시사 에세이" },
  { name: "김경율", nameEn: "Kim Kyung-yul", type: "political_pundit", tags: ["경제정의"], searchQuery: "경제 정의" },
  { name: "서정욱", nameEn: "Seo Jung-wook", type: "political_pundit", tags: ["시사평론가"], searchQuery: "시사 토론" },
